...
EPGProgram.prototype.populate = function () {
  ...
  if (self.element == null) {
    ...
    element.innerHTML =
      '<div class="programTextContainer horizontalAutoscroll"><span>' + title.replace(/&/g, "&amp;") + "</span></div>";

    if (
      self.mediaurl != null &&
      self.mediaurl.length > 0 &&
      self.start_date_obj != null &&
      self.start_date_obj <= curTime
    ) {
